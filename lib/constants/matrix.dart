class Matrix {
  static final questions = [
    ...
    "Peso do objeto estacionário",
    "Comprimento do objeto em movimento",
    "Comprimento do objeto estacionário",
    "Área do objeto em movimento",
    "Área do objeto estacionário",
    "Volume de objeto em movimento",
    "Volume do objeto estacionário",
    "Velocidade",
    "Força (intensidade)",
    "Estresse ou pressão",
    "Forma",
    "Estabilidade da composição do objeto",
    "Força",
    "Duração da ação do objeto em movimento",
    "Duração da ação por objeto estacionário",
    "Temperatura",
    "Intensidade de iluminação",
    "Uso de energia movendo objeto",
    "Uso de energia por objeto estacionário",
    "Força",
    "Perda de energia",
    "Perda de substância",
    "Perda de Informação",
    "Perda de tempo",
    "Quantidade de substância / matéria",
    "Confiabilidade",
    "Precisão de medição",
    "Precisão de fabricação",
    "Fatores prejudiciais afetados por objetos",
    "Fatores prejudiciais gerados por objetos",
    "Facilidade de fabricação",
    "De facil operação",
    "Facilidade de reparo",
    "Adaptabilidade ou versatilidade",
    "Complexidade do dispositivo",
    "Dificuldade de detectar e medir",
  ...
  static final principles = [
    ...
    "Assimetria",
    "Fusão, união ou mistura",
    "Universalidade",
    "Aninhamento",
    "Contrapeso (contrabalançar)",
    "Compensação prévia",
    "Ação prévia",
    "Amortecimento ou proteção prévia",
    "Remova a tensão",
    "Inversão, fazer ao contrário",
    "Curvatura",
    "Dinamização",
    "Ação parcial ou excessiva - um pouco menos ou um pouco mais",
    "Outras dimensões",
    "Ressonância",
    "Ação periódica",
    "Continuidade de uma ação útil",
    "Faça mais rápido / corra",
    "Transformar prejuízo em lucro – transformar limões em limonada",
    "Feedback",
    "Mediação",
    "Autosserviço",
    "Cópia",
    "Uso de objetos descartáveis",
    "Outro sentido",
    "Fluidez",
    "Fino e flexível",
    "Buracos",
  ...
  static final solutionsA = [
    ...
    "Aproxime (ou funda) sistemas ou objetos idênticos ou semelhantes. Reúna peças idênticas ou similares para executar operações paralelas.",
    "Faça com que um objeto ou sistema ou estrutura execute múltiplas funções; elimine a necessidade de outros componentes.",
    "(“Boneca Russa”) Coloque um objeto ou sistema dentro de outro no mesmo espaço; faça com que vários objetos ou sistemas se tornem uma estrutura única.",
    ...
    "Onde existirem tensões negativas, crie condições para compensá-las, reduzi-las ou eliminá-las.",
    ...
    "Use estruturas finas e flexíveis no lugar de grossas e rígidas.",
    "Adicione buracos (ou saídas) em um objeto ou sistema.",
    "Modifique a cor de um objeto ou seu ambiente externo.",
    "Faça sistemas ou objetos interagirem com outros de forma ou propriedades similares.",
  ...
  static final solutionsB = [
    ...
    "",
    "Use um arranjo com multi estruturas em vez de arranjos mono estruturados.",
    "",
    "Se uma ação já periódica, mude a magnitude da periodicidade ou frequência.",
    ...
    "",
    "Coloque em operação partes de um sistema ou objeto que tenham sido descartados.",
    "Altere a concentração ou consistência.",
    "",
    "Faça com que partes diferentes de um sistema reajam diferentemente em resposta a mudanças.",
  ...
  static final solutionsC = [
    ...
    "",
    "",
    "Se uma cópia já está em uso, mude a forma como é vista (iluminação, perspectiva, etc.)",
    "",
    "",
    "",
    "",
